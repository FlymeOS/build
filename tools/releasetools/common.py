  ...
  if fstab_version == 1:
    ...
    for line in data.split("\n"):
      ...
      if not (3 <= len(pieces) <= 4):
        ...
        #[Coron] For Compatibility
        #Do NOT raise exception to break the whole process
...
def GetBootableImage(name, prebuilt_name, unpack_dir, tree_subdir,
  ...
  # [Coron] No need to build image from target files.
...
def MakeRecoveryPatch(input_dir, output_sink, recovery_img, boot_img,
  ...
  #[Coron] Start
  # As we forbid building boot image and recovery image,
  # Using prebuilt image might lead to error when generating.
  # Just do nothing.
  return
  #[Coron] End
